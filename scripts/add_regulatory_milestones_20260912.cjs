...
// Improve meta description with concrete historical entities without changing the URL or canonical.
...
// Add source notes for the new concise regulatory module.
...
// Keep authorship explicit after the new material.
...
// User style rule: no long dashes.
