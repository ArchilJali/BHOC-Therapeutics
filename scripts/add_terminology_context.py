...
ADDITION = '''</p>
      <div class="terminology-context" data-terminology-context="20260917">
        <p><strong>A mindset shaped by its time.</strong> The blood-replacement approach reflected the clinical priorities, scientific knowledge and technological tools available during early development. As that knowledge evolved, advances in vascular biology, oxygen sensing, microcirculation and protein engineering provided a stronger foundation for reconsidering the question. Some of these discoveries are recognized by <a href="https://archiljali.github.io/BHOC-platform/science/nobel-foundations-oxygen-metabolism-physiology.html" target="_blank" rel="noopener noreferrer">Nobel Prizes in the scientific foundations mapped here</a>. For BHOC, the question is no longer whether one product can reproduce blood, but which oxygen-delivery function needs support and under which physiological conditions. These discoveries inform that question; they do not validate a particular product.</p>
        ...
        <p><strong>Reassessment is already under way.</strong> A <a href="https://archiljali.github.io/BHOC-platform/human/BHOC-Human-search.html?q=Blood%20Component%20Requirements&amp;year=2022" target="_blank" rel="noopener noreferrer">2022 HBOC-201 analysis in our library</a> examines blood-component requirements, hemoglobin deficit and mortality in a phase III trial. Our <a href="/bhoc/historical-evolution/#artificial-blood">historical archive</a> also records the 2018 comparison <em>All HBOCs Are Not Created Equally</em> and a 2025 review of biochemical, biophysical and safety differences. These provide a basis for revisiting how older conclusions are applied across different products, not for assuming that all previous safety findings have been overturned.</p>
      </div>
      <p>'''
