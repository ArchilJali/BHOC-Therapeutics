...
ADDITION = '''</p>
      <div class="terminology-context" data-terminology-context="20260917">
        ...
        <p><strong>Reassessment is already under way.</strong> A <a href="https://archiljali.github.io/BHOC-platform/human/BHOC-Human-search.html?q=Blood%20Component%20Requirements&amp;year=2022" target="_blank" rel="noopener noreferrer">2022 HBOC-201 analysis in our library</a> examines blood-component requirements, hemoglobin deficit and mortality in a phase III trial. Our <a href="/bhoc/historical-evolution/#hboc-era">historical archive</a> also records the 2018 comparison <em>All HBOCs Are Not Created Equally</em> and a 2025 review of biochemical, biophysical and safety differences. These provide a basis for revisiting how older conclusions are applied across different products, not for assuming that all previous safety findings have been overturned.</p>
      </div>
      <p>'''
