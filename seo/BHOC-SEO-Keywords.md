...
## 2. Positioning and terminology rules
...
- replacement for blood donors

These expressions may appear only when accurately describing historical language, competitor positioning or a quoted source.

### Terms excluded from this SEO architecture
...
- Use **blood transfusion**, not “blood transplantation”.
- Use **organ transplantation** for transplant medicine.
- Use **heart attack**, **myocardial infarction** and **acute myocardial infarction**, not “hard attack” or “inpoharct”.
- Do not target `SCA` alone. Spell out **sickle cell anemia (SCA)** or **sudden cardiac arrest (SCA)** according to the page context.
...
6. oxygen delivery
7. oxygen carrier
8. hemoglobin oxygen carrier
9. blood
10. blood transfusion

### Core branded combinations

- BHOC oxygen carrier
- BHOC oxygen delivery
- BHOC oxygenation
- BHOC therapeutics
- BHOC platform
- BHOC technology
...
- organ oxygenation
- oxygenation therapeutics

### 4.2 BHOC technology

**Primary:** Biological Hemoglobin Oxygen Carrier

- Biological Hemoglobin Oxygen Carriers
- BHOC technology
- BHOC platform
- hemoglobin oxygen carrier
- oxygen-carrying capacity
- oxygen delivery technology
- intravenous oxygen carrier
- cell-free hemoglobin oxygen carrier
- donor-independent oxygen carrier
- room-temperature oxygen carrier
- universal blood-type compatibility
- oxygen carrier without crossmatching
- ready-to-use oxygen carrier
- controlled infusion oxygen carrier
...
- blood unavailable in emergency
- blood transfusion not available
- blood transfusion not an option
- time-critical oxygen delivery
- immediate oxygen delivery

### 4.4 Prehospital / EMS / HEMS

**Primary:** prehospital oxygenation

- prehospital oxygen delivery
- prehospital resuscitation
- prehospital blood transfusion
- prehospital blood
- EMS blood transfusion
- EMS oxygen carrier
- HEMS blood transfusion
- HEMS oxygenation
- ambulance blood transfusion
- first responder oxygen carrier
- out-of-hospital resuscitation
- point-of-injury oxygen delivery
...
### 4.5 Bloodless resuscitation

**Primary strategic category:** bloodless resuscitation

- bloodless medicine
- bloodless management
- bloodless emergency medicine
- bloodless surgery
- transfusion-free care
- transfusion-free resuscitation
- management without blood transfusion
- emergency care without donor blood
- severe anemia without transfusion
- emergency anemia management
- oxygenation without donor blood
- oxygen delivery when blood is unavailable
- blood transfusion refusal
- blood transfusion contraindicated
- blood conservation
- patient blood management

Recommended category headline:

> **Bloodless Resuscitation: Emergency Oxygenation When Donor Blood Is Not Available**

`Bloodless resuscitation` should be developed as a distinctive BHOC thought-leadership category while being supported by established terms such as `bloodless medicine`, `bloodless management` and `patient blood management`.

### 4.6 Acute anemia

**Primary:** acute anemia
...
- severe anemia without compatible blood
- severe anemia blood transfusion
- emergency management of severe anemia
- oxygen carrier for acute anemia
- oxygen-carrying capacity in anemia

### 4.7 Hemorrhage and hemorrhagic shock

**Primary:** hemorrhagic shock
...
- oxygen delivery in hemorrhagic shock
- emergency transfusion for hemorrhage
- massive transfusion
- massive transfusion protocol
- damage control resuscitation
- oxygen carrier for hemorrhage
- oxygen carrier for blood loss

### 4.8 Ischemia and hypoxia

**Primary:** ischemia and hypoxia
...
- oxygen delivery during hypoxia
- oxygenation in ischemia
- oxygenation in hypoxia
- ischemia-reperfusion injury
- reperfusion injury
- organ reperfusion
- oxygen carrier for ischemia
- oxygen carrier for hypoxia

### 4.9 Heart attack / myocardial infarction

**Primary:** myocardial infarction oxygen delivery
...
- coronary ischemia
- oxygen delivery during myocardial ischemia
- oxygenation in myocardial infarction
- cardiac oxygen delivery
- myocardial oxygen supply
- myocardial reperfusion
- cardiac reperfusion injury
- oxygen carrier for myocardial ischemia
- emergency oxygenation in heart attack

Until evidence is verified for the specific application, use `research context`, `scientific rationale`, `potential application` or `oxygenation challenge`; do not claim that BHOC treats myocardial infarction.

### 4.10 Cardiac arrest

**Primary:** cardiac arrest oxygenation
...
- resuscitation perfusion
- cerebral oxygen delivery after cardiac arrest
- organ perfusion after cardiac arrest
- return of spontaneous circulation
- post-resuscitation oxygenation
- emergency oxygen carrier for resuscitation

Do not target `SCA` alone because it competes with `sickle cell anemia` and other unrelated meanings.
...
- blood transfusion in postpartum hemorrhage
- emergency blood for PPH
- maternal emergency blood
- obstetric emergency transfusion
- maternal hemorrhagic shock
- postpartum blood loss
- PPH resuscitation
- oxygen delivery in maternal hemorrhage
- humanitarian maternal emergency
...
**Primary:** sickle cell disease oxygen delivery
...
- transfusion support for SCD
- red blood cell exchange
- chronic transfusion therapy
- episodic transfusion
- oxygen delivery in sickle cell disease
- oxygen-carrying capacity in SCD
- sickle cell hypoxia
- vaso-occlusive crisis
- SCD organ damage
- SCD alloimmunization
- compatible blood for SCD
- blood shortage for SCD patients
- oxygen carrier research in SCD

Use the complete phrase `sickle cell anemia (SCA)` in titles and opening text. Do not use `SCA` by itself as the primary keyword.
...
**Primary:** organ perfusion

- organ perfusion solution
- oxygenated organ perfusion
- oxygen carrier for organ perfusion
...
- perfusion oxygen carrier
- blood-free perfusion
- red blood cell-free perfusion
- perfusate oxygenation
- perfusion fluid
- perfusion circuit
- graft assessment during perfusion
...
### 4.20 Humanitarian medicine

**Primary:** humanitarian blood supply

- humanitarian emergency
- humanitarian medicine
- blood in humanitarian emergencies
...
- donor blood shortage
- disaster blood supply
- disaster medicine
- armed conflict blood supply
- war zone blood supply
- battlefield blood
- mass casualty blood supply
- remote blood access
- low-resource emergency care
- emergency transfusion in low-resource settings
- humanitarian oxygenation
- humanitarian oxygen carrier
- donor-independent emergency oxygenation
- room-temperature oxygen carrier for humanitarian use

### 4.21 Veterinary medicine

**Primary:** veterinary oxygen carrier

- veterinary oxygenation
- veterinary blood transfusion
- veterinary emergency transfusion
- veterinary anemia
- canine anemia
...
- oxygen carrier for dogs
- oxygen carrier for cats
- oxygen carrier for animals
- wildlife emergency medicine
- wildlife oxygenation
- avian emergency medicine
- Oxyglobin evidence
- veterinary hemoglobin oxygen carrier

### 4.22 Business, market and manufacturing
...
- blood shortage market need
- emergency blood logistics
- donor blood logistics
- blood cold chain
- room-temperature oxygen carrier
- shelf-stable oxygen carrier
- donor-independent manufacturing
- oxygen carrier manufacturing
- hemoglobin purification
- chromatographic purification
- single-use manufacturing
- single-use technology
- SUT biomanufacturing
- modular biomanufacturing
- robotic biomanufacturing
- scalable oxygen carrier manufacturing
- regional manufacturing platform
- healthcare sovereignty
- emergency preparedness asset

### 4.23 Knowledge Hub / evidence / history

**Primary:** BHOC evidence

- BHOC research
- BHOC publications
- Biological Hemoglobin Oxygen Carrier research
- hemoglobin oxygen carrier clinical trials
- oxygen carrier clinical evidence
- oxygen carrier veterinary evidence
- oxygen carrier transplantation evidence
- HBOC research
- HBOC clinical trials
- HBOC history
- hemoglobin therapeutics history
- Biopure history
- Biopure annual report 2001
- Biopure annual report 2002
- Hemopure history
- Oxyglobin history
- Oxyglobin FDA approval
- Oxyglobin EMA authorization
- oxygen carrier regulatory history
- primary source documents
- expanded access oxygen carrier
- severe anemia expanded access
...
### 5.1 Blood and transfusion ecosystem
...
### 5.2 Oxygen and hemoglobin science
...
- oxygen loading
- oxygen unloading
- plasma oxygen carrier
- intravascular oxygen carrier
...
### 5.3 Resuscitation and critical care
...
- golden hour trauma
- time to transfusion
- resuscitation bridge
- bridge to transfusion
- bridge to definitive care
- mass casualty incident
- disaster response
- military medicine

### 5.4 Transplantation procedures and abbreviations
...
- acellular perfusate
- red blood cell-free perfusate

### 5.6 Competitor and adjacent-technology terms

Use only in relevant evidence, history, market or comparison content. Do not place competitor names across every page.
...
- red blood cell-derived oxygen carrier
- encapsulated hemoglobin
- recombinant hemoglobin

### 5.7 Historical terminology only

The following terms may be useful for capturing legacy searches, but they must not define the BHOC brand:
...
Use `artificial blood`, `blood substitute`, `artificial red blood cell` and `synthetic blood` only inside historical, comparative or corrective context explaining why BHOC is not positioned that way.
...
- emergency oxygenation when donor blood is unavailable
- oxygen delivery when blood transfusion is not an option
- donor-independent emergency oxygenation
- room-temperature oxygen carrier for emergencies
- prehospital oxygen carrier
- oxygen carrier for acute anemia
- oxygen carrier for hemorrhagic shock
- oxygen delivery during myocardial ischemia
- oxygenation after cardiac arrest
...
## 7. Recommended page ownership map
...
| Acute Anemia | acute anemia | severe acute anemia, critical anemia, oxygen carrier for anemia |
| Ischemia & Hypoxia | ischemia and hypoxia | oxygen deprivation, oxygen delivery during ischemia |
| Heart Attack | myocardial infarction oxygen delivery | heart attack, myocardial ischemia, cardiac oxygen delivery |
| Cardiac Arrest | cardiac arrest oxygenation | sudden cardiac arrest, post-cardiac arrest care |
| Surgery | surgical blood loss | perioperative anemia, bloodless surgery, PBM |
...
## 8. Recommended initial site architecture

Avoid creating many thin pages before enough verified content exists. The initial high-value application structure can be:

1. **Emergency & Prehospital Oxygenation**
   - Emergency resuscitation
   - Prehospital care
   - Bloodless resuscitation
   - Acute anemia
   - Hemorrhage and hemorrhagic shock
   - Humanitarian and remote emergencies

2. **Ischemia, Hypoxia & Cardiac Applications**
   - Ischemia and hypoxia
   - Heart attack / myocardial infarction
   - Cardiac arrest

3. **Surgery, PPH & Patient Blood Management**
   - Surgical blood loss
   - Perioperative anemia
   - Bloodless surgery
   - Postpartum hemorrhage
...
6. **Veterinary Oxygenation**

Pages can later be separated when sufficient unique evidence and Search Console demand justify dedicated URLs.

---

## 9. On-page implementation rule

For each indexable page select:

- one primary keyword;
- three to five secondary keywords;
- five to ten supporting semantic terms;
- one unique page title;
- one unique H1;
- one unique meta description;
- one clear internal-link anchor from another page;
- descriptive image alt text where appropriate.

Place the primary phrase naturally in:
...
- the page URL where practical;
- one or more relevant internal links.

Do not use invisible keyword blocks, repetitive lists in public page text, or keyword stuffing. A keyword list is a planning tool, not page copy.

## 10. Separation between the two BHOC resources

### `bhoctherapeutics.com`
...
### `ArchilJali/BHOC-platform`

Owns:

- BHOC evidence;
- verified publications;
- regulatory and historical materials;
- institution, author, journal and year catalogues;
- primary documents and scientific source navigation.

Do not publish identical full paragraphs or entire articles on both properties. Use summaries and contextual internal links so each page has a distinct search purpose.

---

## 11. Competitive SEO conclusions

1. Hemarina/HEMO2life is strongest around organ preservation, kidney transplantation, preservation-solution additives and ischemia-reperfusion terminology.
2. KaloCyte/ErythroMer concentrates on trauma, prehospital care, battlefield use, emergency transfusion and shelf-stable emergency access.
...
This is an SEO and market-language document, not a regulatory or clinical-claims document.
